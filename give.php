<?php
/**
 * Plugin Name: Give - Donation Plugin (GoUrl Bitcoin Gateway Support)
 * Plugin URI: https://github.com/cryptoapi/Give-Wordpress-Donations-Bitcoin
...
if ( ! class_exists( 'Give' ) ) :
	...
	final class Give {
		...
		private function setup_constants() {
			...
			define( 'GIVECORE_GOURL', TRUE );

			// Plugin version
			if ( ! defined( 'GIVE_VERSION' ) ) {
				define( 'GIVE_VERSION', '2.0.6.2' );
			}
		...
		private function includes() {
			...
			require_once GIVE_PLUGIN_DIR . 'includes/gateways/gourl_give.php';
